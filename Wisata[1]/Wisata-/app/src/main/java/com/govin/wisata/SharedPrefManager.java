...
public class SharedPrefManager {
    ...
    public String getIdClient(){
        return sp.getString(ID_CLIENT, "");
    }

    public String getNama(){
        return sp.getString(Nama, "Ramdanil");
    }

    public String getTelepon(){
        return sp.getString(Telepon, "081372048313");
    }

    public String getUsername(){
        return sp.getString(Username, "232");
    }
    ...
    public String getEmail(){
        return sp.getString(Email, "danil@gmail.com");
    }
    ...
    public String getStatus(){
        return sp.getString(Status, "Penjual");
    }
